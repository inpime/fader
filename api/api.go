...
import (
	_ "github.com/inpime/fader/addons/filestatic"
	_ "github.com/inpime/fader/addons/importexport"
...
func InitAppSettings() {
	...
	go utils.RefreshEvery(3*time.Second, func() {
		config.Reload()
		vrouter.ReloadAppRouts()
	})
}
...
func Run() error {
	...
	e.Use(func(h echo.HandlerFunc) echo.HandlerFunc {
		return func(ctx echo.Context) error {
			ctx.Response().Header().Set("x-version-id", config.Cfg.Version())
			return h(ctx)
		}
	})
